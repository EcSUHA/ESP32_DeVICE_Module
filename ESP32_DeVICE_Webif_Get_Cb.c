...
// testurl: http://192.168.0.81/DeVICE.get?hello2

/*
 *--------------------------------------------------------------------------------------------------
 *FName: Webif_Get_Cb
 * Desc: For ESP32_DEVICE - the WEBIF_get resource Remote Procedure (RP).
...
int
ESP32_DeVICE_Webif_Get_Cb(WebIf_HTTPDConnSlotData_t* conn)
{
